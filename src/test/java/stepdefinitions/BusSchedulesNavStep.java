...
public class BusSchedulesNavStep {
    ...
    //Hover on Schedules and Map in the top menu
	...
	//Validate the bus schedule page
	...
	//Click on bus schedule - "#99 - UBC B-Line"
	...
	//Rename bus stop name and add to favourites
	...
	//Navigate to manage my favourites page and validate that stop is added to favourites
